...
const articlesToUpdate = [
  { slug: 'umemodoki-bonsai-guide', imageUrl: '/images/articles/umemodoki-bonsai-guide-img-1.png' },
  { slug: 'shimatoneriko-bonsai-guide', imageUrl: '/images/articles/shimatoneriko-bonsai-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ umemodoki-bonsai-guide, shimatoneriko-bonsai-guideのアイキャッチ画像を一括更新中...\n')
