...
const articlesToUpdate = [
  { slug: 'children-bonsai-education-brain-development', imageUrl: '/images/articles/children-bonsai-education-brain-development-img-1.png' },
  { slug: 'water-physiology-stress-response-guide', imageUrl: '/images/articles/water-physiology-stress-response-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ children-bonsai-education-brain-development, water-physiology-stress-response-guideのアイキャッチ画像を一括更新中...\n')
