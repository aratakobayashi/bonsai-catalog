...
const articlesToUpdate = [
  { slug: 'office-bonsai-productivity-workplace-wellness', imageUrl: '/images/articles/office-bonsai-productivity-workplace-wellness-img-1.png' },
  { slug: 'medical-bonsai-therapy-healthcare', imageUrl: '/images/articles/medical-bonsai-therapy-healthcare-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ office-bonsai-productivity-workplace-wellness, medical-bonsai-therapy-healthcareのアイキャッチ画像を一括更新中...\n')
