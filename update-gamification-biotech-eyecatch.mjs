...
const articlesToUpdate = [
  { slug: 'bonsai-gamification-cultivation-tracking-guide', imageUrl: '/images/articles/bonsai-gamification-cultivation-tracking-guide-img-1.png' },
  { slug: 'biotechnology-genetic-optimization-guide', imageUrl: '/images/articles/biotechnology-genetic-optimization-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ bonsai-gamification-cultivation-tracking-guide, biotechnology-genetic-optimization-guideのアイキャッチ画像を一括更新中...\n')
