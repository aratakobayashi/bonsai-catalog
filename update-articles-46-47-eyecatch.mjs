...
const articlesToUpdate = [
  { slug: 'article-46', imageUrl: '/images/articles/article-46-img-1.png' },
  { slug: 'article-47', imageUrl: '/images/articles/article-47-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ article-46, 47のアイキャッチ画像を一括更新中...\n')
