...
const articlesToUpdate = [
  { slug: 'article-41', imageUrl: '/images/articles/article-41-img-1.png' },
  { slug: 'article-43', imageUrl: '/images/articles/article-43-img-1.png' },
  { slug: 'article-44', imageUrl: '/images/articles/article-44-img-1.png' },
  { slug: 'article-45', imageUrl: '/images/articles/article-45-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ 複数記事のアイキャッチ画像を一括更新中...\n')
