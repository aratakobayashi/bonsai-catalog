...
const articlesToUpdate = [
  { slug: 'bonsai-therapy-brain-science-guide', imageUrl: '/images/articles/bonsai-therapy-brain-science-guide-img-1.png' },
  { slug: 'seasonal-temperature-physiology-guide', imageUrl: '/images/articles/seasonal-temperature-physiology-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ bonsai-therapy-brain-science-guide, seasonal-temperature-physiology-guideのアイキャッチ画像を一括更新中...\n')
