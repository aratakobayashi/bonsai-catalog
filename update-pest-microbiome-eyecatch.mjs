...
const articlesToUpdate = [
  { slug: 'bonsai-pest-control-natural-methods', imageUrl: '/images/articles/bonsai-pest-control-natural-methods-img-1.png' },
  { slug: 'root-microbiome-symbiosis-guide', imageUrl: '/images/articles/root-microbiome-symbiosis-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ bonsai-pest-control-natural-methods, root-microbiome-symbiosis-guideのアイキャッチ画像を一括更新中...\n')
