...
const articlesToUpdate = [
  { slug: 'gajumaru-bonsai-guide', imageUrl: '/images/articles/gajumaru-bonsai-guide-img-1.png' },
  { slug: 'article-49', imageUrl: '/images/articles/article-49-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ gajumaru-bonsai-guide, article-49のアイキャッチ画像を一括更新中...\n')
