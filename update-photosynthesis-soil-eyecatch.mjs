...
const articlesToUpdate = [
  { slug: 'indoor-photosynthesis-optimization-guide', imageUrl: '/images/articles/indoor-photosynthesis-optimization-guide-img-1.png' },
  { slug: 'soil-science-ph-nutrition-guide', imageUrl: '/images/articles/soil-science-ph-nutrition-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ indoor-photosynthesis-optimization-guide, soil-science-ph-nutrition-guideのアイキャッチ画像を一括更新中...\n')
