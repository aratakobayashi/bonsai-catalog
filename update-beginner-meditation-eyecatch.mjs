...
const articlesToUpdate = [
  { slug: 'beginner-bonsai-buying-guide-online-vs-store', imageUrl: '/images/articles/beginner-bonsai-buying-guide-online-vs-storeimg-1.png' },
  { slug: 'bonsai-meditation-mindfulness-guide', imageUrl: '/images/articles/bonsai-meditation-mindfulness-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ beginner-bonsai-buying-guide-online-vs-store, bonsai-meditation-mindfulness-guideのアイキャッチ画像を一括更新中...\n')
