...
const articlesToUpdate = [
  { slug: 'article-50', imageUrl: '/images/articles/article-50-img-1.png' },
  { slug: 'article-51', imageUrl: '/images/articles/article-51-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ article-50, 51のアイキャッチ画像を一括更新中...\n')
