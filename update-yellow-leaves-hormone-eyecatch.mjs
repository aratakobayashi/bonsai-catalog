...
const articlesToUpdate = [
  { slug: 'bonsai-yellow-leaves-causes-solutions', imageUrl: '/images/articles/bonsai-yellow-leaves-causes-solutions-img-1.png' },
  { slug: 'plant-hormone-growth-control-guide', imageUrl: '/images/articles/plant-hormone-growth-control-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ bonsai-yellow-leaves-causes-solutions, plant-hormone-growth-control-guideのアイキャッチ画像を一括更新中...\n')
