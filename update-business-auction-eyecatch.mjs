...
const articlesToUpdate = [
  { slug: 'bonsai-business-startup-complete-guide', imageUrl: '/images/articles/bonsai-business-startup-complete-guideimg-1.png' },
  { slug: 'bonsai-auction-strategy-master-guide', imageUrl: '/images/articles/bonsai-auction-strategy-master-guide-img-1.png' }
]

async function updateMultipleEyecatch() {
  console.log('🖼️ bonsai-business-startup-complete-guide, bonsai-auction-strategy-master-guideのアイキャッチ画像を一括更新中...\n')
